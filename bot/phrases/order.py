...
class Order:
    ...
    notification_about_status_order: str = "Статус заказа с номером {} изменился на:{}"
    order_tracked_text: str = "📍Заказ с номером {} теперь отслеживается!"
    ...
    tracking_list_for_user: str = "📍Заказ №{} - статус: <b>{}</b>"
