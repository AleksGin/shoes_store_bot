...
class PathsImages:
    SECOND_MENU_IMG_PATH = f"{PATH_IMAGES}/second_menu_head.jpg"
    REVIEWS_QR = f"{PATH_IMAGES}/reviews_qr.jpeg"
    WELCOME_CROS = f"{PATH_IMAGES}/crossword_head_screen.jpg"
    YUAN_RATES = f"{PATH_IMAGES}/yuan_rate.jpg"
